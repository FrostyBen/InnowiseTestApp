...
class APIClient{
  Future<CurrentWeather> getWeather (Position getPosition) async {

    var weatherResponse = await http.get(Uri.parse('https://api.openweathermap.org/data/2.5/weather?lat=${getPosition.latitude}&lon=${getPosition.longitude}&appid=67033552e6646e901e6110a12160cf68'));
  ...
  Future<ForecastWeather> getForecast(Position getPosition)async{
    var forecastResponse = await http.get(Uri.parse('https://api.openweathermap.org/data/2.5/forecast?lat=${getPosition.latitude}&lon=${getPosition.longitude}&appid=67033552e6646e901e6110a12160cf68'));
